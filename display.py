...
class Display(QLineEdit):
    ...
    def keyPressEvent(self, event: QKeyEvent) -> None:
        ...
        isOperator = key in [
            KEYS.Key_Plus, KEYS.Key_Slash,
            KEYS.Key_Minus, KEYS.Key_Asterisk,
            KEYS.Key_P
         ]
        ...
        if isNumOrDot(text):
            self.numberPressed.emit(text)
            return event.ignore()

        # isso retorna pro widget todas as teclas pressionadas
